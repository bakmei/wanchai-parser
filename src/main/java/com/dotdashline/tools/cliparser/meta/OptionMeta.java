...
public class OptionMeta {
   ...
   public String toString() {
      return new StringBuilder().append(String.format("field: %s%n", field.toString()))
            .append(String.format("annotation: %s%n", annotation))
            .append(String.format("prefixes: %s%n", prefixes.toString())).toString();
   }
